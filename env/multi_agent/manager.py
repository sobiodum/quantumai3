...
class Manager(gym.Env):
    ...
    def step(self, action, worker_observations, worker_rewards, worker_dones, worker_truncateds):
        ...
        # print("Sum worker FREE CASH - Manager end step",self._calculate_free_cash())
        # print("Sum worker stock holdings - Manager end step",self._calculate_share_portfolio())
        # print("self.common_pool - Manager end step",self.common_pool)
        # print("TOTAL PF Value - Manager end step",self._calculate_total_portfolio_value())
        # print("----step Begin ----")
        self.step_count += 1
