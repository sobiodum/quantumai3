...
class StockEnvNAS100:
    def __init__(
        ...
        self.turbulence_bool = (
            turbulence_ary > turbulence_thresh).astype(np.float32)
        self.turbulence_ary = (
    ...
    def reset(
        ...
        *,
        ...
        self.amount = (
            ...
            rd.uniform(0.95, 1.05) - (self.stocks * price).sum()
        )
        ...
        if self.turbulence_bool[self.day] == 0:
            ...
            for index in np.where(actions > min_action)[0]:  # buy_index:
                if (
                    ...
                    buy_num_shares = min(
                        self.amount // price[index], actions[index])
    ...
    def draw_cumulative_return(self, args, _torch) -> list:
        ...
        with _torch.no_grad():
            for i in range(self.max_step):
                ...
                total_asset = (
                    self.amount +
                    (self.price_ary[self.day] * self.stocks).sum()
                )
